...
\begin{definition}[Language invariant property]
...
\begin{theorem}[Stelling I by Rice]
...
\marton{is Stelling part of the theorem name? It's just theorem in Dutch, right?}
