...
\end{definition}
\martonst{if $T$ is a subgraph}{if $T$ is a tree and a subgraph}
...
\marton{I feel like these figures would be more intuitive if the role of the dotted and the solid lines were reversed.}
...
\marton{The labels on this figure are not translated, I wasn't sure if I should edit the .fig directly}
...
\begin{proof}
\martonst{At the end of}{The result} of the algorithm $T$ is a tree with $n$ vertices, 
$(n-1)$ edges, \martonst{and cycle free,}{(comment: we already declared it a tree)} so $T$ is a spanning tree $G$. We still need to prove termination of the algorithm and the minimality of $T$.
